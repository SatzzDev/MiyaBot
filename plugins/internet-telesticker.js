...
return await miya.sendImageAsSticker(m.chat, await getBuffer(randomSticker.url), m, {packname, author}) 
}
...
return await miya.sendImageAsSticker(m.chat, await getBuffer(stickers[stickerNumber].url), m, {packname, author})
}

for (let i = 0; i < stickers.length; i++) {
await  miya.sendImageAsSticker(m.chat, await getBuffer(stickers[i].url), m, {packname, author})
