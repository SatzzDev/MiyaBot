...
const { imageMessage } = await generateWAMessageContent({ 'image': { 'url': imageUrl } }, { 'upload': miya.waUploadToServer });
return imageMessage;
}
...
await miya.relayMessage(m.chat, messageContent.message, {
